...
namespace WFDotNetCoreGravarDadosMySQL
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //chamar a função carrear contatos
            CarregarContatos();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //vamos colocar a lógica do código aqui dentro do IF
                    Conexao = new MySqlConnection(data_source);
                    Conexao.Open();
            ...
            {
                MessageBox.Show("Error" + ex.Number + "Ocorreu :" + ex.Message,
                   "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            catch (Exception ex)
            {
                MessageBox.Show("Ocorreu" + ex.Message + "Erro:" + ex.Message,
                  "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
